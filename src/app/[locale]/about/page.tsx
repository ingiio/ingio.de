    ...
    <main>
      ...
      <section className="section bg-gradient-to-b from-[#151718] to-[#1a1c1e]">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Team */}
          <div className="card">
            <h2 className="text-2xl font-bold mb-8 gradient-text">{t('team.title')}</h2>
            
            <div className="grid md:grid-cols-3 gap-8">
              {['founder', 'tech', 'solutions'].map((member) => (
                <div key={member} className="text-center">
                  ...
                  <p className="text-purple-400 mb-2">{t(`team.${member}.role`)}</p>
                  <p className="text-gray-400 text-sm">{t(`team.${member}.bio`)}</p>
                </div>
              ))}
            </div>
          </div>
